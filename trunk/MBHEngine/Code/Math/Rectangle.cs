...
namespace MBHEngine.Math
{
    ...
    public class Rectangle
    {
        ...
        public Rectangle(Single width, Single height)
        {
            pDimensions = new Vector2(width, height);
            pCenterPoint = new Vector2();
        }
        ...
        /// <param name="height">The height from top edge to bottom edge.</param>
        /// <param name="center">The position of this rectangle.</param>
        public Rectangle(Single width, Single height, Vector2 center)
        {
            pDimensions = new Vector2(width, height);
            pCenterPoint = center;
        }
        ...
        public Rectangle(Vector2 dimension)
        {
        ...
        public Rectangle(Vector2 dimension, Vector2 center)
        {
            pDimensions = dimension;
            pCenterPoint = center;
        }
