...
namespace MBHEngine.Behaviour
{
    ...
    public class SpriteRender : MBHEngine.Behaviour.Behaviour
    {
        ...
        public class SetActiveAnimationMessage : BehaviourMessage
        {
            ...
            /// <summary>
            /// If this is a non-looping animation, which has already completed, should the
            /// call to set the animation also trigger it to restart.
            /// </summary>
            public Boolean mDoNotRestartIfCompleted_In;
            ...
            public override void Reset()
            {
                ...
                mDoNotRestartIfCompleted_In = false;
            }
        }
