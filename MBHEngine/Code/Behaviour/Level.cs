...
namespace MBHEngine.Behaviour
{
    ...
    public class Level : MBHEngine.Behaviour.Behaviour
    {
        ...
        private void UpdateEdgeCollisionData(Tile t, Boolean updateAdjacent)
        {
                ...
                for (Int32 x = startX; x < endX; x++)
                {
                    ...
                    if (mCollisionGrid[x, y].mType != Level.Tile.TileTypes.Empty)
                    {
                        ...
                        if (mCollisionGrid[x, y].HasAttribute(Tile.Attribute.Collision))
                            DebugShapeDisplay.pInstance.AddAABB(mCollisionGrid[x, y].mCollisionRect, Color.Red, true);
                        // If a collision was even checked for, render it Orange.
                            ...
                            DebugShapeDisplay.pInstance.AddAABB(mCollisionGrid[x, y].mCollisionRect, Color.OrangeRed, true);
                        else
                            DebugShapeDisplay.pInstance.AddAABB(mCollisionGrid[x, y].mCollisionRect, Color.Black, true);
                    ...
                    else
                    {
                        ...
                        {
                            DebugShapeDisplay.pInstance.AddAABB(mCollisionGrid[x, y].mCollisionRect, Color.Pink, true);
                        }
                    }
                }
            }
